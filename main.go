...
import (
	...
	// "github.com/yankiwi/wlc_exporter/collectors"
...
var (
	...
	sshUsername   = flag.String("ssh.user", "wlc_exporter", "Username to use when connecting to devices using ssh")
...
func init() {
	...
	flag.Usage = func() {
		fmt.Println("Usage: wlc_exporter [ ... ]\n\nParameters:")
		fmt.Println()
		flag.PrintDefaults()
	}
}
...
func startServer() {
	log.Infof("starting wlc_exporter (version: %s)\n", version)
...
<html>
  ...
  <body>
    ...
    <p><a href="https://github.com/slashdoom/wlc_exporter">github.com/slashdoom/wlc_exporter</a></p>
  </body>
</html>
`))
	})
